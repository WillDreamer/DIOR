...
def run():
    ...
    method  = args.Tag
    our = importlib.import_module(method)
...
def load_config():
    ...
    parser.add_argument('-d', '--dataset', default = 'cifar-10',choices=['cifar-10', 'coco', 'imagenet100', 'nus-wide-tc-10', 'flickr25k'],
                        help='Dataset name.')
    ...
    parser.add_argument('-tag', '--Tag', default='method', type=str,
                        help='Baseline Name')
    ...
    parser.add_argument('--noise', default=True, type=bool,
                        help='Whether to add noise to label .(default:True)')
    parser.add_argument('--noiseType', default='pairflip', type=str,
                        help='Noise type.(default: pairflip)')
    parser.add_argument('-nl', '--noiseLevel', default=0.6, type=float,
                        help='Noise Level.(default: 0.6)')
