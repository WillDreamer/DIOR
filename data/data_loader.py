...
def load_data(dataset, root, num_query, num_train, batch_size, num_workers,noise,noiseType,noiseLevel):
    """
    Load dataset.
    ...
    if dataset == 'cifar-10':
        ...
        query_dataloader, train_dataloader, retrieval_dataloader = coco.load_data(root,
                                                                            num_query,
                                                                            num_train,
                                                                            batch_size,
                                                                            num_workers,
